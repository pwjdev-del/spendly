...
const nextConfig: NextConfig = {
  ...
  experimental: {
    serverActions: {
      bodySizeLimit: '50mb', // Increased for PDF reconciliation uploads
    },
  ...
  // turbopack is a valid Next.js 16 config option but might be missing from types
  turbopack: {},
};
...
const withPWA = require('next-pwa')({
  ...
  runtimeCaching: [
    ...
    {
      handler: 'NetworkFirst',
      urlPattern: ({ request, url: { pathname }, sameOrigin }: any) => {
