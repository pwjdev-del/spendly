...
export function SiaButton({ className }: { className?: string }) {
    ...
    return (
        <Button
            onClick={toggle}
            className={cn(
                "fixed bottom-6 right-6 z-50 h-14 w-14 rounded-full p-0 shadow-2xl transition-all duration-300 hover:scale-110 hover:shadow-[0_0_40px_-10px_rgba(99,102,241,0.6)]",
